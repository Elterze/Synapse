...
class QRadarApi:
    ...
    def __init__(self, server, certificate_file, version, auth_token=None, username=None, password=None):
        ...
        try:
            ...
            raise Exception('Disabling SSLv2 and SSLv3 is not supported on versions of OpenSSL prior to 0.9.8m.')
